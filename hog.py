...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            player_roll0 = strategy0(score0, score1)
            score0 += take_turn(player_roll0,score1,dice,goal)
            score0 += hog_pile(score0,score1)
        else:
            player_roll1 = strategy1(score1, score0)
            score1 += take_turn(player_roll1,score0,dice,goal)
...
def make_averaged(original_function, trials_count=1000):
    ...
    def new_func(*args):
        ...
        while i <= trials_count:
            ...
            i +=1
        average_result = total / trials_count
